...
Rules:
- TASK START: Someone announcing they're about to work on something with an estimated time
- TASK COMPLETION: Someone announcing they finished work with actual time taken

For TASK START: set "estimated_minutes" with the time, "actual_minutes" must be null
